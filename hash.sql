-- Arquivo hash.sql - Testes de consultas com índice HASH
...
DROP INDEX IF EXISTS idx_emprestimo_livro_count_hash;

DROP INDEX IF EXISTS idx_livro_ano_count_hash;
...
-- 1. Criar índice HASH na coluna nome da tabela usuario
...
-- 2. Criar índice HASH na coluna id_usuario da tabela emprestimo
...
-- 3. Criar índice HASH na coluna id_livro da tabela emprestimo
...
-- 4. Criar índice HASH na coluna ano_publicacao da tabela livro
...
-- 5. Criar índice HASH na coluna id_livro da tabela emprestimo
CREATE INDEX idx_emprestimo_livro_count_hash ON emprestimo USING HASH (id_livro);
...
-- 6. Criar índice HASH na coluna ano_publicacao da tabela livro
...
-- 7. Criar índice HASH na coluna id_livro da tabela emprestimo
...
-- 8. Criar índice HASH na coluna area da tabela livro
...
-- 9. Criar índice HASH na coluna hremprestimo da tabela emprestimo
...
-- 10. Criar índice HASH nas colunas dtemprestimo e dtdevolucao da tabela emprestimo
